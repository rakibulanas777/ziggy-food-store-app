                ...
                <div className="grid grid-cols-1 relative lg:grid-cols-2 gap-8 items-center">
                    ...
                    <div className=" w-full md:w-[32rem] flex flex-col space-y-6 ">
                        ...
                        <div className="flex gap-8 items-center">
                            <button onClick={handleNavigate} className=" bg-[#f54748] active:scale-90 transition duration-150 transform hover:shadow-xl shadow-md rounded-full px-8 py-2 text-xl font-medium text-white">About us</button> 
                        </div>
                    </div>
                </div>
            </div>
