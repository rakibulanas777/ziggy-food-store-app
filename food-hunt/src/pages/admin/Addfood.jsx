...
const Addfood = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        const foodData = { name, price, foodImage, catagory, location, description, coupon };

        const res = await axios.post("http://localhost:8001/api/v1/food/addfood", { name, price, foodImage, catagory, location, description, coupon }, {
            headers: {
